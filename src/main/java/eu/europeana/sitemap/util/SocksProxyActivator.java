 ...
 * Note that this has to be done before any connections are set-up, so early during startup. Also note that Java NIO
 * classes do not support using a socks proxy.
 *
...
public final class SocksProxyActivator {
    ...
    /**
     * This will activate the use of a Socks Proxy if the provided configuration is valid and has it enabled.
    ...
    /**
     * Check if the provided configuration contains settings for activating a socks proxy and if it is set to enabled
     *
