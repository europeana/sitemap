...
public class SitemapApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(SitemapApplication.class).web(WebApplicationType.NONE).run(args);
    }
    ...
    private static void validateArg(String[] args) {
        ...
        if (!RECORD.name().equalsIgnoreCase(taskArg)
            ...
            if (LOG.isErrorEnabled()) {
                LOG.error("Unsupported argument '{}'. Supported arguments are '{}' and '{}'",
                        taskArg,
                        RECORD.name(),
                        ENTITY.name());
            }
    ...
    public void run(String... args) throws Exception {
        ...
        UpdateAbstractService updateService = RECORD.name().equalsIgnoreCase(taskArg) ? updateRecordService : updateEntityService;
