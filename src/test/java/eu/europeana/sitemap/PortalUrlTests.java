...
public class PortalUrlTests {
    ...
    public void testGetRecordUrl() {
        ...
        assertEquals(PORTAL_BASE_URL + "/portal/record/92092/BibliographicResource_1000086018920.html",
    ...
    public void testGetEntityUrlCanonical() {
        String type1 = "Agent";
        String id1 = "312";
        assertEquals(PORTAL_BASE_URL + "/portal/explore/people/312", fnp.getEntityUrl(type1, id1));

        String type2 = "Concept";
        String id2 = "999";
        assertEquals(PORTAL_BASE_URL + "/portal/explore/topics/999", fnp.getEntityUrl(type2, id2));
    }
    ...
    public void testGetEntityUrlLanguage() {
        ...
        assertEquals(PORTAL_BASE_URL + "/portal/en/explore/people/11-frederic-leighton-1st-baron-leighton.html", result1);
        ...
        assertEquals(PORTAL_BASE_URL + "/portal/ru/explore/topics/664.html", result2);
        ...
        assertEquals(PORTAL_BASE_URL + "/portal/it/explore/people/93590-w-j-gruffydd-elerydd.html", result3);
    }
}
